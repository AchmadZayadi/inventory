...
public class new_item extends AppCompatActivity {
     ...
     /*   getSupportActionBar().setLogo(R.drawable.tokoo);*/
        ...
        ton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (ID.equals("")|| nama.equals("")||barang_baru.equals("") || Tanggal.equals("")||status.equals(""))
                {
                ...
                {
                    postData(ID,nama,barang_baru,status,Tanggal);
    ...
    public void postData(final String ID, final String nama, final String barang_baru ,final String status , final String Tanggal){
        final ProgressDialog progressDialog;
       // Log.d("isnya",ID+","+nama+","+barang_baru+","+status+","+Tanggal);
        progressDialog = new ProgressDialog(new_item.this);
        progressDialog.show();
        String url = "http://192.168.88.44:1777/item";
