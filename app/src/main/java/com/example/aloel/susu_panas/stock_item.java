...
public class stock_item extends AppCompatActivity
{
    // Movies json url
    private static final String url = "http://192.168.100.54:1777/itemstock";
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        try
                        {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                model_barang.stock = object.getString("total");
                                model_barang.nama = object.getString("name");
